...
function getPaymentStatus(reservation: Reservation) {
  ...
  const newBookings = reservations.filter(
  ...
  const onHold = reservations.filter(
    (r) => r.status === "pending"
  ).length;
    ...
    <>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Here is what is going on with your property today.
        </p>
      </div>
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-3">
        ...
        <div className="xl:col-span-2 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="overflow-x-auto">
            ...
            {todayActivity.length === 0 ? (
              ...
              <div className="p-10">
                <EmptyState text="No reservations for today." />
              </div>
              ...
              <div className="divide-y divide-slate-100">
                ...
                {todayActivity.slice(0, 10).map((reservation) => {
                  ...
                  return (
                    <div
                      key={reservation.id}
                      className="min-w-[850px] p-5 hover:bg-slate-50"
                    >

                      <div className="grid grid-cols-[1.4fr_1.2fr_1.4fr_1fr_1fr_1fr] items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500">
                            {reservation.room?.room_type?.name || "Room"}
                          </p>
                        </div>
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            ...
                            className="rounded-lg border border-slate-200 px-3 py-2 text-xs font-bold hover:bg-white"
                          >
                            Bill
                          </button>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="p-5">
            ...
            <div className="mb-3 grid grid-cols-3 text-xs font-bold uppercase text-slate-400">
            ...
            {rooms.length === 0 ? (
              ...
              <EmptyState text="No rooms configured." />
              ...
              Array.from(
                ...
                const inventory = categoryRooms.filter(
                  (room) => room.status === "available"
                ).length;
                ...
                return (
                  <div
                    key={roomTypeName}
                    className="grid grid-cols-3 items-center border-t border-slate-100 py-4 text-sm"
                  >
