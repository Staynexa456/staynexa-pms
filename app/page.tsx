...
// ═══════════════════════════════════════════════
// SPARKLINE COMPONENT (SVG line chart)
// ═══════════════════════════════════════════════
function Sparkline({
  data,
  color = "#0d9488",
...
export default function DashboardPage() {
  ...
  // ═══ Mock trend data for sparklines (ভবিষ্যতে real data যোগ হবে) ═══
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          ...
          <div className="group relative bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl hover:shadow-emerald-100/50 hover:border-emerald-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white text-xl shadow-lg shadow-emerald-500/30">
                🛬
              </div>
            ...
            <div className="flex items-center justify-between mt-3">
              <p className="text-xs text-slate-500">
                {stats.pendingCheckins.length} pending
              </p>
          ...
          <div className="group relative bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl hover:shadow-rose-100/50 hover:border-rose-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-rose-400 to-rose-600 flex items-center justify-center text-white text-xl shadow-lg shadow-rose-500/30">
                🛫
              </div>
              <span className="text-[10px] font-bold px-2.5 py-1 bg-rose-50 text-rose-700 rounded-full">
                Today
              </span>
            </div>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            ...
            <div className="flex items-center justify-between mt-3">
              <p className="text-xs text-slate-500">
                {stats.pendingCheckouts.length} pending
              </p>
          ...
          <div className="group relative bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl hover:shadow-sky-100/50 hover:border-sky-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-sky-400 to-sky-600 flex items-center justify-center text-white text-xl shadow-lg shadow-sky-500/30">
                👥
              </div>
              <span className="text-[10px] font-bold px-2.5 py-1 bg-sky-50 text-sky-700 rounded-full">
                Active
              </span>
            </div>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            ...
            <div className="mt-3">
              ...
              <p className="text-xs text-slate-500 mt-2">
                {stats.occupancyRate.toFixed(0)}% occupancy
              </p>
            </div>
          </div>
          ...
          <div className="group relative bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl hover:shadow-amber-100/50 hover:border-amber-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-white text-xl shadow-lg shadow-amber-500/30">
                💰
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="p-4 bg-gradient-to-br from-emerald-50 to-emerald-50/30 rounded-xl border border-emerald-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Sparkline
                    data={[2, 3, 2.5, 4, 3.5, 5, stats.todayCollection / 1000 || 4]}
                    color="#10b981"
                    width={60}
                    height={24}
                  />
                ...
                <p className="text-2xl font-bold text-emerald-700">
                  {fmtShort(stats.todayCollection)}
                </p>
              ...
              <div className="p-4 bg-gradient-to-br from-sky-50 to-sky-50/30 rounded-xl border border-sky-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Sparkline
                    data={[3, 4, 3.5, 5, 4.5, 6, stats.weekCollection / 1000 || 5]}
                    color="#0ea5e9"
                    width={60}
                    height={24}
                  />
            ...
            <div className="mt-5 pt-5 border-t border-slate-100">
              <div className="flex items-center justify-between mb-2">
                ...
                <p className="text-sm font-bold text-emerald-600">
                  {stats.cleanlinessPercent.toFixed(0)}%
                </p>
              </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-5">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Awaiting collection from guests
                </p>
              </div>
            ...
            <div className="p-4 bg-gradient-to-r from-rose-50 to-white rounded-xl border border-rose-100 mb-5">
              ...
              <p className="text-4xl font-bold text-rose-700 mt-2 tracking-tight">
                {fmtFull(stats.totalPending)}
              </p>
            </div>
            ...
            <div className="space-y-2 max-h-52 overflow-y-auto">
              {stats.inHouseGuests
                ...
                .map((g) => (
                  <div
                    key={g.id}
                    className="flex items-center justify-between p-3 bg-slate-50 hover:bg-slate-100 rounded-lg transition group"
                  >
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <Link
                        href="/calendar"
                        className="text-[10px] font-bold text-slate-400 group-hover:text-teal-600 uppercase tracking-wide transition"
                      >
                        Collect →
                      </Link>
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-emerald-50 to-emerald-50/30 border-b border-emerald-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white text-lg shadow-md shadow-emerald-500/30">
                  🛬
                </div>
                <div>
                  ...
                  <p className="text-[10px] text-emerald-600 font-medium">
                    {stats.arrivalCount} scheduled
                  </p>
                </div>
              </div>
              <Link
                href="/reports/front-desk/arrivals"
            ...
            <div className="p-4 space-y-2 max-h-72 overflow-y-auto">
              {stats.arrivalsToday.length === 0 ? (
                ...
                stats.arrivalsToday.map((b) => (
                  <div
                    key={b.id}
                    className="flex items-center justify-between p-3 bg-emerald-50/50 hover:bg-emerald-100 rounded-xl border border-emerald-100 transition"
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-rose-50 to-rose-50/30 border-b border-rose-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-rose-400 to-rose-600 flex items-center justify-center text-white text-lg shadow-md shadow-rose-500/30">
                  🛫
                </div>
                <div>
                  ...
                  <p className="text-[10px] text-rose-600 font-medium">
                    {stats.departureCount} scheduled
                  </p>
                </div>
              </div>
              <Link
                href="/reports/front-desk/departures"
            ...
            <div className="p-4 space-y-2 max-h-72 overflow-y-auto">
              {stats.departuresToday.length === 0 ? (
                ...
                stats.departuresToday.map((b) => (
                  <div
                    key={b.id}
                    className="flex items-center justify-between p-3 bg-rose-50/50 hover:bg-rose-100 rounded-xl border border-rose-100 transition"
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
