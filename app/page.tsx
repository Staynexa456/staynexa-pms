      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5">
          ...
          <p className="text-xs text-slate-500 mt-1">
            ...
            {stats.arrivalCount - stats.pendingCheckins.length} checked-in
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5">
          ...
          <p className="text-xs text-slate-500 mt-1">
            ...
            {stats.departureCount - stats.pendingCheckouts.length} checked-out
          </p>
        </div>
                  ...
                  style={{
                    width: `${Math.min(
                      ...
                      stats.monthCollection > 0
                        ? (stats.todayCollection / stats.monthCollection) * 100
                        : 0
                    )}%`,
                  }}
                />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-semibold text-slate-500">
              {stats.arrivalsToday.length} total
            </span>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-semibold text-slate-500">
              {stats.departuresToday.length} total
            </span>
          </div>
          <div className="space-y-2 max-h-64 overflow-y-auto">
