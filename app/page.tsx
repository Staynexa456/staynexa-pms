...
// --- TYPES (Kept from your original code) ---
type RoomType = {
  id: string;
  name: string;
  base_price: number;
...
export default function DashboardPage() {
  ...
  // Example: How you would fetch data later
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center sticky top-0 z-10">
        <div className="flex items-center gap-6">
          <div className="w-8 h-8 bg-slate-900 text-white flex items-center justify-center rounded font-bold text-lg">
            S
          </div>
          ...
          <div className="relative ml-4 hidden md:block">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border border-gray-300 rounded text-sm w-64 outline-none focus:border-slate-500"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <a href="#" className="hidden md:flex text-sm text-gray-500 hover:underline items-center gap-1">
        ...
        <div className="xl:col-span-3 space-y-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1 text-sm md:text-base">
                Here is what going on with your property on <span className="font-semibold underline decoration-dotted">12 Sep 2026</span>
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-6">
            <input
              ...
              className="w-full md:w-1/2 p-2 border border-gray-300 rounded text-sm outline-none focus:border-slate-500"
            />
            <div className="flex gap-2 items-center text-sm w-full md:w-auto justify-end">
              ...
              <select className="border border-gray-300 rounded p-1.5 outline-none">
          ...
          <div className="bg-white border border-gray-200 rounded shadow-sm divide-y divide-gray-100">
            {bookingsData.map((b, idx) => (
              <div key={idx} className="p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center text-sm">
                ...
                <div className="md:col-span-3">
                  <p className="text-gray-600 text-xs">{b.dates}</p>
                </div>
                <div className="md:col-span-2 md:text-right">
                  <div className="flex items-center md:justify-end gap-1 text-gray-800 font-medium text-xs">
                    <Key size={12} /> {b.room}
                  </div>
        ...
        <div className="xl:col-span-1 space-y-4">
          ...
          <div className="bg-white border border-gray-200 rounded shadow-sm p-5 text-center relative">
            ...
            <p className="text-xs text-gray-600 mb-4">
              Review <a href="#" className="text-blue-600 hover:underline">Razorpay's</a> account opening guidelines to get started.
            </p>
            <button className="border border-gray-800 text-gray-800 text-xs font-bold px-4 py-2 rounded hover:bg-gray-50">
              SETUP NOW
            </button>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded shadow-sm p-5 text-center">
            ...
            <p className="text-xs text-gray-500 mb-4">
              Revenue management service by Stayflexi to boost your online bookings by 30%.
            </p>
